...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background selection:bg-primary/20">
      <aside className="w-64 shrink-0 shadow-[1px_0_15px_rgba(0,0,0,0.03)] z-10">
        <AdminSidebar />
      </aside>
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 shrink-0 items-center justify-between border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-8 z-10">
