...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { title: "Ingresos (mes)", value: stats?.monthlyRevenue ? `$${stats.monthlyRevenue.toLocaleString("es-CL")}` : "-", icon: DollarSign },
  ];
          ...
          <CardContent>
            <div className="space-y-3">
              {stats.topClinics.map((clinic, i) => (
                <div key={clinic.id} className="flex items-center justify-between rounded-md border px-4 py-3">
